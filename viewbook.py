				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation">
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li><a href="pviewbook.py">Booking View</a></li>
...
<table>
<tr><td>&nbsp&nbsp&nbspProp Id &nbsp&nbsp&nbsp</td><td>Name&nbsp&nbsp&nbsp</td><td>Email&nbsp&nbsp&nbsp</td><td>Phone Number</td></tr>
""")
for i in x:
	print("""
	<tr><td>&nbsp&nbsp&nbsp%s</td><td>%s</td><td>%s</td><td>%s</td></tr>
	"""%(i[1],i[2],i[3],i[4]))
print("""
</table>
